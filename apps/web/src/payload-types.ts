...
export interface Config {
  ...
  jobs: {
    tasks: {
      ...
      createRazorpayLinkedAccount: TaskCreateRazorpayLinkedAccount;
      inline: {
        input: unknown;
        output: unknown;
      };
    ...
    workflows: {
      vendorActivation: WorkflowVendorActivation;
    };
  };
  /**
...
/**
 * Seller accounts on the DTlea platform
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'sendEmail' | 'createRazorpayLinkedAccount';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  workflowSlug?: 'vendorActivation' | null;
  taskSlug?: ('inline' | 'sendEmail' | 'createRazorpayLinkedAccount') | null;
  queue?: string | null;
...
export interface Footer {
  id: string;
  /**
   * Optional footer logo. Falls back to the site wordmark if empty.
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskCreateRazorpayLinkedAccount".
 */
export interface TaskCreateRazorpayLinkedAccount {
  input: {
    tenantId: string;
  };
  output: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "WorkflowVendorActivation".
 */
export interface WorkflowVendorActivation {
  input: {
    tenantId: string;
    ownerName: string;
    ownerEmail: string;
