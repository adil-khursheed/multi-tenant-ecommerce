...
const steps: StepConfig[] = [
  {
    ...
    fields: Object.keys(businessInfoBaseSchema.shape),
  },
  {
    id: "address",
    label: "Store Address",
  ...
  },
  {
    ...
    fields: Object.keys(bankAccountBaseSchema.shape),
  },
  {
    id: "review",
    label: "Review",
        ...
        <div className="mb-2 flex items-center gap-3 lg:hidden">
          ...
          <div>
            <p className="text-xs font-medium uppercase tracking-[0.15em] text-primary">
              {currentStep?.id !== "review" ? currentStep.stepLabel : ""}
            </p>
      ...
      <div className="w-full lg:max-w-3xl grow lg:w-3/4">
        ...
        <div className="mb-8 lg:mb-12">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground sm:text-base lg:mt-6 lg:text-lg">
            {currentStep?.id === "payment" && currentStep.description}
          </p>
        </div>
