...
export const businessInfoBaseSchema = z.object({
...
export const businessInfoSchema = businessInfoBaseSchema.superRefine(
  (data, ctx) => {
...
export const bankAccountSchema = bankAccountBaseSchema.refine(
  (data) => data.isIFSCVerified,
  {
